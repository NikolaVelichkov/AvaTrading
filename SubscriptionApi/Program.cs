...
var connectionString = builder.Configuration.GetConnectionString("SubscriptionContextConnection") ?? throw new InvalidOperationException("Connection string 'ShoppingListContextConnection' not found.");
